...
class CarriedBoxSceneManager:
    ...
    def __init__(
        self,
        node,
        object_id: str = 'green_box_carried',
    ...
    def attach_box(
        ...
        if self.object_id in self.attached_ids():
            self.node.get_logger().warning(
                'The green-box collision object '
                'is already attached.'
            )
            return
        ...
        self.node.get_logger().info(
            'MoveIt attached the green box to '
            f'{self.attach_link}.'
        )
    ...
    def detach_box(
        ...
        self.apply_scene(
            scene,
            'detach and remove carried green box',
        )
        ...
        self.node.get_logger().info(
            ...
            'carried green-box collision object.'
        )
