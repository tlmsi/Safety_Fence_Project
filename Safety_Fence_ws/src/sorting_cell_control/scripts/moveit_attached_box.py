...
class CarriedBoxSceneManager:
    ...
    def attach_box(
        ...
        self.node.get_logger().info(
            'MoveIt attached the red box to '
            f'{self.attach_link}.'
        )
    ...
    def detach_box(
        ...
        self.apply_scene(
            scene,
            'detach and remove carried red box',
        )
        ...
        self.node.get_logger().info(
            ...
            'carried red-box collision object.'
        )
